...
export function ContinueReadingCard() {
  ...
  return (
    <Link data-semantic="navigation-card" to={route} state={{ restoreReading: true }} className="interactive-clay flex items-center gap-4 rounded-[var(--radius-lg)] border border-ui-green-strong/20 bg-ui-green/45 p-5 shadow-[var(--shadow-sm)] outline-none hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-ring sm:p-6">
