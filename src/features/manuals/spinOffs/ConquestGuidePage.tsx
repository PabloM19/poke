...
export function ConquestGuidePage() {
  return (
    <article className="space-y-8">
      ...
      <LessonCallout kind="note">La gestión de reinos se amplía gradualmente. Aprende primero objetivo, movimiento y acción; el recurso R-06 reunirá el recordatorio táctico.</LessonCallout>
