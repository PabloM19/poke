import { Compass, Skull, Sparkles } from 'lucide-react'
  ...
  return (
    <article className="space-y-10">
      <header className="overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-primary/15 via-card to-secondary p-5 sm:p-8">
        <div className="mb-5 flex size-12 items-center justify-center rounded-xl bg-primary text-primary-foreground"><Compass className="size-6" aria-hidden /></div>
        <p className="text-sm font-semibold uppercase tracking-widest text-primary">Mundo Misterioso · Equipo de Exploración</p>
        <h1 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">Exploradores de la Oscuridad</h1>
