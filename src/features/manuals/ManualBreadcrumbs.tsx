  ...
  return (
    <nav aria-label="Migas de pan" className="mb-5">
      <ol className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
        <li><Link to="/manuales" className="rounded-sm hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Manuales</Link></li>
        <li aria-hidden><ChevronRight className="size-4" /></li>
        <li className="text-foreground" aria-current="page">{entry?.shortTitle ?? 'No encontrado'}</li>
      </ol>
    </nav>
  )
}
